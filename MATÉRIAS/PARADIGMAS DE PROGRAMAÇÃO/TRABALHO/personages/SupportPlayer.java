...
public class SupportPlayer extends Personage {

    // Construtor
    public SupportPlayer(int lin, int col, int attack, int defense, boolean isAlive) {
    ...
    public void move(String choice, Personage player, Sector[][] board) {
        ...
        if (choice == "U" || choice == "u") {
            ...
            if (sides[0] == '*') {
                board[lin][col].setHasSupportPlayer(false);
                board[lin - 1][col].setHasSupportPlayer(true);
